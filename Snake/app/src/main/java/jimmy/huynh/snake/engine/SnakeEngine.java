package jimmy.huynh.snake.engine;
...
import jimmy.huynh.snake.dialog.DialogConfirm;
...
//            newGame();
    ...
    private void showDialog(Context context) {
        ...
        dialogConfirm = new DialogConfirm(context, new DialogConfirm.DialogConfirmListener() {
            @Override
    ...
    private Thread getInstanceThread() {
        if (thread == null) {
            thread = new Thread(this);
        }
        return thread;
    ...
    private void setScoreToServer() {
        ...
        obj.saveInBackground(new DoneCallback() {
            ...
            public void done(NCMBException e) {
                if (e != null) {
                    //保存が失敗した場合の処理
                    Log.e("NCMB", "Error:" + e.getMessage());
                } else {
                    //保存が成功した場合の処理
                    Log.i("NCMB", "Successfull...");
                }
            }
        });
    }
